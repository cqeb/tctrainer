...
<div class="container">
    ...
    <div class="col-xs-6 col-sm-6 col-lg-3">
        ...
        <ul class="footer-links">
			<li><a href="https://getsatisfaction.com/tricoretraining" target="_blank"><?php __('Support'); ?></a></li>
	...
	<div class="col-xs-6 col-sm-6 col-lg-3">
        ...
        <ul class="footer-links">
			<li><?php echo $html->link(__('Triathlon Training',true),array('controller' => 'starts', 'action' => 'features'))?></li>
			<li><?php echo $html->link(__('Marathon Training',true),array('controller' => 'starts', 'action' => 'features'))?></li>

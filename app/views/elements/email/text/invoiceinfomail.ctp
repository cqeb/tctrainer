...
<?php __('You will receive an invoice as soon as our payment provider (PAYPAL) charges the subscription fee. This will happen after your trial period expired.'); ?>

...
<tr id="comp-<?php echo $this_comp_id; ?>">
     ...
     <td><?php echo $html->link($unitcalc->check_date($competition['Competition']['competitiondate']), '/competitions/edit_competition' . '/' . $competition['Competition']['id'] . '/', null); $cday = date('D', strtotime($competition['Competition']['competitiondate'])); echo ", " . __($cday, true); ?></td>
     <td><?php echo $html->link(__($competition['Competition']['sportstype'], true), '/competitions/edit_competition' . '/' . $competition['Competition']['id'] . '/', null) ?></td>
     <td><?php echo $html->link($competition['Competition']['name'], '/competitions/edit_competition' . '/' . $competition['Competition']['id'] . '/', null) ?></td>

...
class ResizeHelper extends AppHelper {
  ...
  */
  ...
  function resize($imagePath, $opts=null)
  {
      ...
      $cacheFolder = Configure::read('App.serverUrl') . '/cache/'; # path to your cache folder, must be writeable by web server
      ...
      $cache_http_minutes = 60; # cache downloaded http images 20 minutes

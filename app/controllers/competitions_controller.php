...
class CompetitionsController extends AppController {
   ...
   function list_competitions()
   {
        ...
        if ( $session_userid )  {
            ...
            $sql = "SELECT count(*) AS countcomps FROM competitions WHERE user_id = " . $session_userid  . 
                    " AND important = 1 AND competitiondate BETWEEN '" .
            ...
            $competitions = $checkcompetition = $create_dummy = null;
        }
   ...
   function edit_competition($id = null) 
   {
        ...
        } else
        {
            ...
            */
            $sql = "SELECT * FROM competitions WHERE user_id = " . $session_userid . " AND name = '" . 
                $this->data['Competition']['name'] .
                "' AND competitiondate = '" . $competition_date . "'";

            $Comps_already = $this->Competition->query( $sql );
            if ( count( $Comps_already ) > 0 ) 
                $error = __('This event already exists!',true);

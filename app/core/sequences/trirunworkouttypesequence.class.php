<?php
class TriRunWorkoutTypeSequence extends Sequence {
	protected $sequence = array(
		// TODO review this sequence
		"E", // Endurance
		"S", // Speed Skills
		"F", // Force
		"S",
	...
	protected function resume(Athlete $athlete, DateTime $week) {
		...
		$res = $this->DB->query("SELECT * FROM trirunworkouttypesequence WHERE athlete_id = " .
	...
	public function save() {
		...
		$this->DB->query("DELETE FROM trirunworkouttypesequence WHERE athlete_id = " .
			$this->athlete->getId() . " AND week = '" . $week . "'");
		
		//now insert new one
		$sql = "INSERT INTO trirunworkouttypesequence " .

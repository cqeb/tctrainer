...
class SwimWorkout extends Workout {
	...
	switch ($this->type) {
			case Workout::E1:
				...
				break;
			case Workout::E2:
				return __('Swim intervals of medium intensity, that take 5-10 minutes, and recover for 30 to 60 seconds.', true);
				break;
			case Workout::E3:
			...
			case Workout::F3:
				...
				break;
			case Workout::M1:
				return __('Swim intervals of 6 minutes or more at high intensity. Recover for up to 2 minutes. Try to swim your next race distance.', true);
				break;
			case Workout::M2:
				return __('Swim intervals to a maximum of 5 minutes at high intensity. Recover for less than 1 minute, and try to cover your next race distance.', true);
				break;
			case Workout::M3:
				return __('Swim at race speed and do not recover. Stop after a maximum of 30 minutes.', true);
				break;
			default:
				return 'UNKNOWN';
				break;
